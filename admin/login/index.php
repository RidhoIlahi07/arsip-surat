        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form action="proses_login.php" id="login" name="login" method="post">
              ...
              <div class="form-group has-feedback">
                <input type="password" id="password" name="password_admin" class="form-control" autocomplete="off" maxlength="50" placeholder="Password" required="password" />
              ...
              <div class="separator">
                <div>
                  <h2><i class="fa fa-institution"></i> PEMERTINTAH DESA JURIT BARU</h2>
                  <p>©2021 TEKNIK INFORMATIKA UNRAM</p>
                </div>
              </div>
            </form>
          </section>
