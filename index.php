...
<html lang="en">
  <head>
    ...
    <title>Sistem Informasi Pengelolaan Surat dan Kearsipan Desa Jurit Baru</title>
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">PENGELOLAAN SURAT <span class="logo-dec">JURIT BARU</span></a>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="banner-info text-center wow fadeIn delay-05s">
              ...
              <div class="logo">
		            <img src="img/lombok_timur.png" alt="" />
	            </div>
              <h3 class="bnr-sub-title">SISTEM INFORMASI PENGELOLAAN SURAT DAN KEARSIPAN</h3>
                <h3 class="bnr-sub-title"><span class="logo-dec">DESA JURIT BARU</span></h3>
            </div>
          </div>
        </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="sub-title pad-bt15">Website ini berguna untuk pengelolaan surat dan pengarsipan Surat di Desa Jurit Baru</p><p>Surat diarsipkan dalam format PDF lalu disesuaikan nomor urutnya.</p>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
            <figure>
              <img src="img/KKN.jpEg" class="img-responsive">
              <figcaption>
                  <h2>KKN Desa Jurit Baru</h2>
                  <p>"UNIVERSITAS MATARAM 2021"</p>
