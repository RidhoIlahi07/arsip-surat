                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                             <?php
                              ...
                              $sql1  		= "SELECT * FROM surat_sk order by id_sk asc";                        
                      ...
                      <tbody>
                            ...
                            while($data = mysqli_fetch_array($query1)){
                              echo'<tr>
                                <td>	'. $no.'		</td>
                                <td>	'. $data['no_sk'].'	</td>
                                <td>	'. $data['tentang_sk'].'  		</td>
                                <td>	'. $data['tanggal_sk'].'		</td> 
                                <td>	'. $data['penerbit_sk'].'		</td> 
                                ...
                                <td style="text-align:center;">
                                  ...
                                  <a href=editSK.php?id_sk='.$data['id_sk'].'><button type="button" title="Edit" class="btn btn-success btn-xs"><i class="fa  fa-edit"></i></button></a>
                                  <a onclick="return konfirmasi()" href="proses/proses_hapus.php?id_sk='.$data['id_sk'].'"><button type="button" title="Hapus" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></button></a>
                                </td>
                              </tr>';
                              $no++;
                            }
