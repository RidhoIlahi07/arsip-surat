          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Surat Masuk ><small>Edit Surat Keluar</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form action="proses/proses_editsurat.php" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            $tgl_keluar = $data['tgl_suratkeluar'];
                            $tgl_keluar = date('m-d-Y H:i:s', strtotime($tgl_keluar));
                            $tgl_surat = $data['tgl_suratkeluar'];
                      ...
                      <div class="form-group">
                        ...
                        <div class='input-group date' id='myDatepicker4'>
                            <input value="<?php echo "$tgl_keluar" ?>" type='text' id="tgl_suratkeluar" name="tgl_suratkeluar" required="required" class="form-control" required="required" readonly="readonly" />
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php echo $data['no_suratkeluar'];?>" type="text" id="no_suratkeluar" name="no_suratkeluar" required="required" maxlength="50" placeholder="Masukkan No Surat" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <textarea name="isi_suratkeluar" id="isi_suratkeluar" cols="30" rows="10"required="required" placeholder="Masukkan Isi" class="form-control col-md-7 col-xs-12"><?php echo $data['isi_suratkeluar'];?></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php echo $data['perihal_suratkeluar'];?>" type="text" id="perihal_suratkeluar" name="perihal_suratkeluar" required="required" maxlength="50" placeholder="Masukkan Prihal" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php echo $data['penerima_suratkeluar'];?>" type="text" id="penerima_suratkeluar" name="penerima_suratkeluar" required="required" maxlength="50" placeholder="Masukkan Prihal" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php echo $data['pengirim_suratkeluar'];?>" type="text" id="pengirim_suratkeluar" name="pengirim_suratkeluar" required="required" maxlength="50" placeholder="Masukkan Prihal" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
