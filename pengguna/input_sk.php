                    ...
                    <form action="proses/proses_inputsurat.php"  name="formpengguna" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="no_sk" name="no_sk" required="required"  placeholder="Masukkan Nomor Surat" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" id="tentang_sk" name="tentang_sk" required="required" placeholder="Masukkan tentang surat " class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <div class='input-group date' id='myDatepicker4'>
                                <input type='text' id="tanggal_sk" name="tanggal_sk" required="required" class="form-control" required="required" readonly="readonly" />
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="penerbit_sk" name="penerbit_sk" required="required" placeholder="Masukkan Penerbit " class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <textarea  name="keputusan_sk" id="keputusan_sk" cols="30" rows="10"required="required" placeholder="Masukkan Keputusan" class="form-control col-md-7 col-xs-12"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <textarea  name="keterangan_sk" id="keterangan_sk" cols="30" rows="10"required="required" placeholder="Masukkan Keputusan" class="form-control col-md-7 col-xs-12"></textarea>
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="datasuratSK.php" class="btn btn-success"><span class="glyphicon glyphicon-arrow-left"></span> Batal</a>
