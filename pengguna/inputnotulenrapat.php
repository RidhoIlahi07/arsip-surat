                    ...
                    <form action="proses/proses_inputsurat.php/"  name="formpengguna" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="id_notulen" name="no_suratnotulen" required="required"  placeholder="Masukkan No Surat" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="pemimpin_notulen" name="pemimpin_notulen" required="required"  placeholder="Masukkan Pemimpin Rapat " class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class='input-group date' id='myDatepicker4'>
                            <input type='text' id="tanggal_notulen" name="tanggal_notulen" required="required" class="form-control" required="required" readonly="readonly" />
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="tempat_notulen" name="tempat_notulen" required="required"  placeholder="Masukkan Tempat Rapat" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <textarea  name="agenda_notulen" id="agenda_notulen" cols="30" rows="10"required="required" placeholder="Masukkan Agenda Rapat" class="form-control col-md-7 col-xs-12"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="pengirim_notulen" name="pengirim_notulen" required="required" placeholder="Masukkan Pengirim Rapat " class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="penerima_notulen" name="penerima_notulen" required="required" placeholder="Masukkan Penerima Rapat" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <textarea  name="hasil_notulen" id="hasil_notulen" cols="30" rows="10"required="required" placeholder="Masukkan Agenda Rapat" class="form-control col-md-7 col-xs-12"></textarea>
                        </div>
                      </div>
