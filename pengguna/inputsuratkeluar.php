                    ...
                    <form action="proses/proses_inputsurat.php"  name="formpengguna" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      <div class="form-group">
                        ...
                        <div class='input-group date' id='myDatepicker4'>
                            <input type='text' id="tgl_suratkeluar" name="tgl_suratkeluar" required="required" class="form-control" required="required" readonly="readonly" />
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="no_suratkeluar" name="no_suratkeluar" required="required"  placeholder="Masukkan Nomor Surat" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <textarea  name="isi_suratkeluar" id="isi_suratkeluar" cols="30" rows="10"required="required" placeholder="Masukkan Isi" class="form-control col-md-7 col-xs-12"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="perihal_suratkeluar" name="perihal_suratkeluar" required="required" placeholder="Masukkan Perihal " class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="penerima_suratkeluar" name="penerima_suratkeluar" required="required" placeholder="Masukkan Penerima " class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="pengirim_suratkeluar" name="pengirim_suratkeluar" required="required" maxlength="50" placeholder="Masukkan Pengirim" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
