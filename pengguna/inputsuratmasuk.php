                  ...
                  <div class="x_content">
                    ...
                    <form action="proses/proses_inputsurat.php"  name="formpengguna" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="no_suratmasuk" name="no_suratmasuk" required="required"  placeholder="Masukkan Nomor Surat" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <textarea  name="isi_suratmasuk" id="isi_suratmasuk" cols="30" rows="10"required="required" placeholder="Masukkan Isi" class="form-control col-md-7 col-xs-12"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="perihal_suratmasuk" name="perihal_suratmasuk" required="required" placeholder="Masukkan Perihal " class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="penerima_suratmasuk" name="penerima_suratmasuk" required="required" placeholder="Masukkan Penerima " class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="pengirim_suratmasuk" name="pengirim_suratmasuk" required="required" maxlength="50" placeholder="Masukkan Pengirim" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
