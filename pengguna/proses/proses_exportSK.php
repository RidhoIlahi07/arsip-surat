...
// Mengambil data dari tabel
                    $bulan=$_POST['bulan'];
                    $tahun=$_POST['tahun'];	
                    $sql1  		= "SELECT * FROM surat_sk WHERE MONTH(tanggal_sk)='$bulan' AND YEAR(tanggal_sk) = '$tahun'";                        
                ...
                $nama_file = 'SURAT KEPUTUSAN  '.$_SESSION['nama'].'-'.$bulan.'-'.$tahun;
...
$excelku->getActiveSheet()->setCellValue('A6', "DATA SURAT KEPUTUSAN BULAN $bulan TAHUN $tahun");
...
$SI = $excelku->setActiveSheetIndex(0);
 ...
 $SI->setCellValue('B8', "NOMOR SK");
 $SI->setCellValue('C8', "TENTANG");
 $SI->setCellValue('D8', "TANGGAL SK");
 $SI->setCellValue('E8', "PENERBIT");
 $SI->setCellValue('F8', "KEPUTUSAN");
 $SI->setCellValue('G8', "KETERANGAN");
...
while ($data = $query1->fetch_assoc()) {
  ...
  $SI->setCellValue("B".$baris,$data['no_sk']); 
  $SI->setCellValue("C".$baris,$data['tentang_sk']); 
  $SI->setCellValue("D".$baris,$data['tanggal_sk']); 
  $SI->setCellValue("E".$baris,$data['penerbit_sk']); 
  $SI->setCellValue("F".$baris,$data['keputusan_sk']); 
  $SI->setCellValue("G".$baris,$data['keterangan_sk']); 
...
//Memberi nama sheet
$excelku->getActiveSheet()->setTitle('DataSuratKeputusan');
