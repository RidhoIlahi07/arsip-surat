...
while ($data = $query1->fetch_assoc()) {
  ...
  $SI->setCellValue("B".$baris,$data['id_suratmasuk']); 
  $SI->setCellValue("C".$baris,$data['tgl_suratmasuk']); 
  $SI->setCellValue("D".$baris,$data['no_suratmasuk']); 
  $SI->setCellValue("E".$baris,$data['isi_suratmasuk']); 
  $SI->setCellValue("F".$baris,$data['perihal_suratmasuk']); 
  $SI->setCellValue("G".$baris,$data['penerima_suratmasuk']); 
  $SI->setCellValue("H".$baris,$data['pengirim_suratmasuk']); 
